    ...
    jQuery(function($){
		//crop image
    	$('#queryfill').tagsInput({    
    		  autocomplete_url:'/face-portlet/getdata.jsp',
    		  autocomplete:{highlightItem: true,scroll: true,scrollHeight: 300,width:'150px'},
    		  'defaultText':'add a tag',
    		   'onAddTag':addATag,
    		   'onRemoveTag':removeATag,
...
//	  successFunc();
//	}, threshold);
//		if($("#area" + tagId).attr("title")!=undefined)
//		{
//			location.href='/web/'+$("#area" + tagId).attr("title");	
//		}
